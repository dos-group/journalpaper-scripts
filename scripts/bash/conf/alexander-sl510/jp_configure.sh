...
ALL_SLAVES=${JP_SCRIPTS_HOME}/scripts/bash/conf/alexander-sl510/all_slaves
# list of all current slaves
CUR_SLAVES=${JP_SCRIPTS_HOME}/scripts/bash/conf/alexander-sl510/cur_slaves
...
HADOOPMR_TAR=/home/alexander/etc/hadoop-1.0.4.tar.gz
# path to Hadoop MR root folder
HADOOPMR_HOME=/home/alexander/etc/hadoop-1.0.4.tar.gz
...
STRATOSPHERE_TAR=/home/alexander/etc/stratosphere-0.2.tar.gz
