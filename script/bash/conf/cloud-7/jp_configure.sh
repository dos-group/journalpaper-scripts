...
DGEN_HOME=${JP_SCRIPT_DIR}/datagen
...
ALL_SLAVES=${JP_SCRIPT_DIR}/script/bash/conf/cloud-7/all_slaves
# list of all current slaves
CUR_SLAVES=${JP_SCRIPT_DIR}/script/bash/conf/cloud-7/cur_slaves
...
# path to Stratosphere deployment archive used for Meteor 
STRATOSPHERE_TAR_METEOR=/share/journalpaper/systems/stratosphere-0.2-meteor.tar.gz
